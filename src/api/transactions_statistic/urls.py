...
from src.api.transactions_statistic.controller import get_list_transactions, get_list_error_transactions, get_list_card_transactions, get_list_pre_auth_transactions, get_transactions_statistic
...
rest_transactions_statistic_service.add_url_rule('statistic', methods=['GET'], view_func=get_transactions_statistic)